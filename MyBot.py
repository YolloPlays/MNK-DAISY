...
class Bot2(Player):
    """
    Blocker Bot with new features. Random placements are controlled by the 
    ...
    def make_move(self, board, m=None, n=None):
        ...
        empty_cells_higher_prob = self.free_cells_to_pick(empty_cells)
        check_for = 2
    ...
    def free_cells_to_pick(self, cells):
